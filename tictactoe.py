...
def is_winning_move(player):
	...
	for r in range(ROW):
		if board[r][0] == player and board[r][1] == player and board[r][2] == player:
			print(announcement)
			pygame.draw.line(window, win_color, (10,(r*200)+100), (WIDTH-10,(r*200)+100), 10)
			return True
	for c in range(COL):
		if board[0][c] == player and board[1][c] == player and board[2][c] == player:
			print(announcement)
			pygame.draw.line(window, win_color, ((c*200)+100,10), ((c*200)+100,HEIGHT-10), 10)
			return True
	if board[0][0] == player and board[1][1] == player and board[2][1] == player:
		print(announcement)
		pygame.draw.line(window, win_color, (10,10), (HEIGHT-10,WIDTH-10), 10)
		return True	
	if board[0][2] == player and board[1][1] == player and board[2][0] == player:
		print(announcement)
		pygame.draw.line(window, win_color, (10,WIDTH-10), (HEIGHT-10, 10), 10)
		return True
